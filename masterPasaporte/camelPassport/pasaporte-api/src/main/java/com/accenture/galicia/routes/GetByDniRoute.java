...
import com.accenture.galicia.processes.GetByDniProcessor;
...
@Component
public class GetByDniRoute extends RouteBuilder{
	...
	public void configure() throws Exception {
		...
		from(DirectRoutesShortcuts.GET_PASSPORT_DNI)
