...
public class GeneralMultipleResponseProcessor implements Processor {
	...
	public void process(Exchange exchange) throws Exception {
		...
		GeneralResponse<Passport[]> grl = new GeneralResponse<Passport[]>(
				"Status: " + exchange.getIn().getHeader("CamelHttpResponseCode"), null,
				exchange.getIn().getBody(Passport[].class));
		// log.info("GeneralResponse: Pasaporte: " +
		// exchange.getIn().getBody(Passport.class).toString());
